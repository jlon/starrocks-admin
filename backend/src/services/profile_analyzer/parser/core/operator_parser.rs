...
impl OperatorParser {
    ...
    pub fn canonical_topology_name(operator_name: &str) -> String {
        ...
        match name.as_str() {
            ...
            // Aggregate operators
            "AGGREGATE" | "AGGREGATION" | "AGGREGATE_BLOCKING" | "AGGREGATE_STREAMING" => "AGGREGATE".to_string(),
            
            // Exchange operators
            // EXCHANGE_SINK contains NetworkTime which is needed for time calculation
            "EXCHANGE" | "EXCHANGE_SOURCE" | "EXCHANGE_SINK" | "MERGE_EXCHANGE" => "EXCHANGE".to_string(),
    ...
    pub fn extract_operator_block(text: &str, operator_name: &str, plan_node_id: Option<i32>) -> String {
