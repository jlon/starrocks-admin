...
# 自动生成的镜像标签:
# - ghcr.io/jlon/starrocks-admin:v1.0.0
...
# 自动生成的镜像标签:
# - ghcr.io/jlon/starrocks-admin:main
# - ghcr.io/jlon/starrocks-admin:main-<commit-sha>
```
...
# 拉取特定版本
docker pull ghcr.io/jlon/starrocks-admin:v1.0.0
...
| 触发方式 | 生成的标签 | 示例 |
|---------|-----------|------|
| 推送 `v1.2.3` 标签 | `v1.2.3`, `1.2`, `1`, `latest` | `ghcr.io/jlon/starrocks-admin:v1.2.3` |
| 推送到 `main` 分支 | `main`, `main-<sha>` | `ghcr.io/jlon/starrocks-admin:main` |
| Pull Request | `pr-<number>` | `ghcr.io/jlon/starrocks-admin:pr-42` |
...
修改镜像可见性:
1. 访问 `https://github.com/jlon/starrocks-admin/pkgs/container/starrocks-admin`
...
graph TB
    subgraph GitHub["GitHub 平台"]
        Code[代码仓库<br/>jlon/starrocks-admin]
